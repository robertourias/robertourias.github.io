...
export default function Projects() {
  return (
    <section id="projects" className="py-20 md:py-24 px-6 md:px-8 bg-surface-container-low">
            ...
            >
              ...
              <div className="p-6 md:p-8">
                ...
                <a
                  ...
                  className="font-display text-xl font-bold text-on-surface mb-4 hover:text-primary transition-colors block"
                >
                  {project.title}
                </a>
